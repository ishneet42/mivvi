...
export function HeaderUserMenu() {
  ...
  return (
    <div ref={wrapRef} className="relative">
      <button
        onClick={() => setOpen((v) => !v)}
        className="focus:outline-none focus:ring-2 focus:ring-ink focus:ring-offset-2 focus:ring-offset-paper-deep rounded-full"
      ...
      {open && (
        <div
          className="absolute right-0 top-11 w-64 rounded-2xl bg-paper-cream border border-[rgba(32,36,43,0.08)] shadow-[0_20px_60px_-20px_rgba(32,36,43,0.25)] overflow-hidden z-50"
        >
          {/* Identity card */}
          <div className="px-4 py-4 flex items-center gap-3 border-b border-[rgba(32,36,43,0.06)]">
            <Avatar
              size={40}
              name={name}
              emoji={profile?.avatarEmoji ?? null}
          ...
          <div className="py-1">
            <Link
              ...
              className="flex items-center gap-3 px-4 py-2.5 text-sm hover:bg-[rgba(32,36,43,0.05)] transition"
            >
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-2.5 text-sm hover:bg-[rgba(32,36,43,0.05)] transition text-left"
            >
          ...
          <div className="border-t border-[rgba(32,36,43,0.06)] py-1">
            <button
              onClick={() => signOut({ redirectUrl: '/' })}
              className="w-full flex items-center gap-3 px-4 py-2.5 text-sm hover:bg-[rgba(216,65,42,0.08)] transition text-clay-ink text-left"
            >
